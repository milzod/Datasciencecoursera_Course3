...
Xtraining <- read.csv(paste0(getwd(),"/", "UCI HAR Dataset/train/X_train.txt"), sep = "", header = FALSE)
Ytraining <- read.csv(paste0(getwd(),"/", "UCI HAR Dataset/train/y_train.txt"), sep = "", header = FALSE)
Subtraining <- read.csv(paste0(getwd(),"/", "UCI HAR Dataset/train/subject_train.txt"), sep = " ", header = FALSE)

# 1.2: Load X, Y and subject test data files 
Xtest <- read.csv(paste0(getwd(),"/", "UCI HAR Dataset/test/X_test.txt"), sep = "", header = FALSE)
Ytest <- read.csv(paste0(getwd(),"/", "UCI HAR Dataset/test/y_test.txt"), sep = "", header = FALSE)
Subtest <- read.csv(paste0(getwd(),"/", "UCI HAR Dataset/test/subject_test.txt"), sep = " ", header = FALSE)
